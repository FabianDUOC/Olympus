...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Direccion',
            fields=[
                ('idDireccion', models.AutoField(primary_key=True, serialize=False, verbose_name='Código de la Dirección')),
                ('nombre', models.CharField(max_length=50, verbose_name='Nombre de la Dirección')),
                ('idUsuario', models.IntegerField(unique=True)),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('comuna', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.comuna', verbose_name='Comuna de pertenencia')),
            ],
        ),
        migrations.AddField(
            model_name='comuna',
            name='region',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.region', verbose_name='Region de pertenencia'),
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
